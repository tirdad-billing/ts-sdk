...
import { workflowsQueryWorkflow } from "@tirdad-ai/sdk/funcs/workflows-query-workflow.js";
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.WorkflowExecutionFilter](../../sdk/models/workflow-execution-filter.md)                                                                                                | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.ListWorkflowsResponse](../../sdk/models/list-workflows-response.md)\>**
