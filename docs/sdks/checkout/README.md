...
import { checkoutCreateCheckoutSession } from "@tirdad-ai/sdk/funcs/checkout-create-checkout-session.js";
...
async function run() {
  const result = await tirdad.checkout.getCheckoutSession("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { checkoutGetCheckoutSession } from "@tirdad-ai/sdk/funcs/checkout-get-checkout-session.js";
...
async function run() {
  const res = await checkoutGetCheckoutSession(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  await tirdad.checkout.deleteCheckoutSession("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { checkoutDeleteCheckoutSession } from "@tirdad-ai/sdk/funcs/checkout-delete-checkout-session.js";
...
async function run() {
  const res = await checkoutDeleteCheckoutSession(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
...
<!-- UsageSnippet language="typescript" operationID="cancelCheckoutSession" method="post" path="/checkout/sessions/{id}/cancel" -->
```typescript
import { Tirdad } from "@tirdad-ai/sdk";
...
async function run() {
  const result = await tirdad.checkout.cancelCheckoutSession("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { checkoutCancelCheckoutSession } from "@tirdad-ai/sdk/funcs/checkout-cancel-checkout-session.js";
...
async function run() {
  const res = await checkoutCancelCheckoutSession(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("checkoutCancelCheckoutSession failed:", res.error);
  }
}
