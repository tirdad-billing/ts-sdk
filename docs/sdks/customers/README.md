...
async function run() {
  const result = await tirdad.customers.updateCustomer({});
...
import { customersUpdateCustomer } from "@tirdad-ai/sdk/funcs/customers-update-customer.js";
...
async function run() {
  const res = await customersUpdateCustomer(tirdad, {});
  if (res.ok) {
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersCreateCustomer } from "@tirdad-ai/sdk/funcs/customers-create-customer.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.CreateCustomerRequest](../../sdk/models/create-customer-request.md)                                                                                                    | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await tirdad.customers.getCustomerByExternalId("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersGetCustomerByExternalId } from "@tirdad-ai/sdk/funcs/customers-get-customer-by-external-id.js";
...
async function run() {
  const res = await customersGetCustomerByExternalId(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
<!-- UsageSnippet language="typescript" operationID="getSubscriptionsForCustomer" method="get" path="/customers/external/{external_id}/subscriptions" -->
```typescript
import { Tirdad } from "@tirdad-ai/sdk";
...
async function run() {
  const result = await tirdad.customers.getSubscriptionsForCustomer("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersGetSubscriptionsForCustomer } from "@tirdad-ai/sdk/funcs/customers-get-subscriptions-for-customer.js";
...
async function run() {
  const res = await customersGetSubscriptionsForCustomer(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("customersGetSubscriptionsForCustomer failed:", res.error);
  }
}
...
async function run() {
  const result = await tirdad.customers.queryCustomer({});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersQueryCustomer } from "@tirdad-ai/sdk/funcs/customers-query-customer.js";
...
async function run() {
  const res = await customersQueryCustomer(tirdad, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
**Promise\<[models.ListCustomersResponse](../../sdk/models/list-customers-response.md)\>**
...
async function run() {
  const result = await tirdad.customers.getCustomerUsageSummary();
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersGetCustomerUsageSummary } from "@tirdad-ai/sdk/funcs/customers-get-customer-usage-summary.js";
...
async function run() {
  const res = await customersGetCustomerUsageSummary(tirdad);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
**Promise\<[models.CustomerUsageSummaryResponse](../../sdk/models/customer-usage-summary-response.md)\>**
...
async function run() {
  const result = await tirdad.customers.getCustomer("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersGetCustomer } from "@tirdad-ai/sdk/funcs/customers-get-customer.js";
...
async function run() {
  const res = await customersGetCustomer(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  await tirdad.customers.deleteCustomer("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersDeleteCustomer } from "@tirdad-ai/sdk/funcs/customers-delete-customer.js";
...
async function run() {
  const res = await customersDeleteCustomer(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await tirdad.customers.getCustomerEntitlements("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersGetCustomerEntitlements } from "@tirdad-ai/sdk/funcs/customers-get-customer-entitlements.js";
...
async function run() {
  const res = await customersGetCustomerEntitlements(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.customers.getCustomerUpcomingGrants("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { customersGetCustomerUpcomingGrants } from "@tirdad-ai/sdk/funcs/customers-get-customer-upcoming-grants.js";
...
async function run() {
  const res = await customersGetCustomerUpcomingGrants(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
