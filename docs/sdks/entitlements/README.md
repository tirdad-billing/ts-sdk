...
async function run() {
  const result = await tirdad.entitlements.getAddonEntitlements("<id>");
...
import { entitlementsGetAddonEntitlements } from "@tirdad-ai/sdk/funcs/entitlements-get-addon-entitlements.js";
...
async function run() {
  const res = await entitlementsGetAddonEntitlements(tirdad, "<id>");
  if (res.ok) {
...
**Promise\<[models.ListEntitlementsResponse](../../sdk/models/list-entitlements-response.md)\>**
...
async function run() {
  const result = await tirdad.entitlements.createEntitlement({
    featureId: "<id>",
    featureType: "metered",
  });
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { entitlementsCreateEntitlement } from "@tirdad-ai/sdk/funcs/entitlements-create-entitlement.js";
...
async function run() {
  const res = await entitlementsCreateEntitlement(tirdad, {
    featureId: "<id>",
    featureType: "metered",
  });
  if (res.ok) {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.CreateEntitlementRequest](../../sdk/models/create-entitlement-request.md)                                                                                              | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.EntitlementResponse](../../sdk/models/entitlement-response.md)\>**
...
async function run() {
  const result = await tirdad.entitlements.createEntitlementsBulk({
    items: [
      {
        featureId: "<id>",
        featureType: "static",
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { entitlementsCreateEntitlementsBulk } from "@tirdad-ai/sdk/funcs/entitlements-create-entitlements-bulk.js";
...
async function run() {
  const res = await entitlementsCreateEntitlementsBulk(tirdad, {
    items: [
      {
        featureId: "<id>",
        featureType: "static",
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.CreateBulkEntitlementRequest](../../sdk/models/create-bulk-entitlement-request.md)                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.CreateBulkEntitlementResponse](../../sdk/models/create-bulk-entitlement-response.md)\>**
...
async function run() {
  const result = await tirdad.entitlements.queryEntitlement({});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { entitlementsQueryEntitlement } from "@tirdad-ai/sdk/funcs/entitlements-query-entitlement.js";
...
async function run() {
  const res = await entitlementsQueryEntitlement(tirdad, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.EntitlementFilter](../../sdk/models/entitlement-filter.md)                                                                                                             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await tirdad.entitlements.getEntitlement("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { entitlementsGetEntitlement } from "@tirdad-ai/sdk/funcs/entitlements-get-entitlement.js";
...
async function run() {
  const res = await entitlementsGetEntitlement(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.entitlements.updateEntitlement("<id>", {});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { entitlementsUpdateEntitlement } from "@tirdad-ai/sdk/funcs/entitlements-update-entitlement.js";
...
async function run() {
  const res = await entitlementsUpdateEntitlement(tirdad, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.entitlements.deleteEntitlement("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { entitlementsDeleteEntitlement } from "@tirdad-ai/sdk/funcs/entitlements-delete-entitlement.js";
...
async function run() {
  const res = await entitlementsDeleteEntitlement(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.entitlements.getPlanEntitlements("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { entitlementsGetPlanEntitlements } from "@tirdad-ai/sdk/funcs/entitlements-get-plan-entitlements.js";
...
async function run() {
  const res = await entitlementsGetPlanEntitlements(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
