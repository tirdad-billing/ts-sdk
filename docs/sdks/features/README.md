...
async function run() {
  const result = await tirdad.features.createFeature({
    meter: {
      aggregation: {},
...
import { featuresCreateFeature } from "@tirdad-ai/sdk/funcs/features-create-feature.js";
...
async function run() {
  const res = await featuresCreateFeature(tirdad, {
    meter: {
      aggregation: {},
      eventName: "api_request",
      name: "API Usage Meter",
...
async function run() {
  const result = await tirdad.features.queryFeature({});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { featuresQueryFeature } from "@tirdad-ai/sdk/funcs/features-query-feature.js";
...
async function run() {
  const res = await featuresQueryFeature(tirdad, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.features.updateFeature("<id>", {});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { featuresUpdateFeature } from "@tirdad-ai/sdk/funcs/features-update-feature.js";
...
async function run() {
  const res = await featuresUpdateFeature(tirdad, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.features.deleteFeature("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { featuresDeleteFeature } from "@tirdad-ai/sdk/funcs/features-delete-feature.js";
...
async function run() {
  const res = await featuresDeleteFeature(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.features.cloneFeature("<id>", {});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { featuresCloneFeature } from "@tirdad-ai/sdk/funcs/features-clone-feature.js";
...
async function run() {
  const res = await featuresCloneFeature(tirdad, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
