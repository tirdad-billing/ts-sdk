...
async function run() {
  const result = await tirdad.tasks.listTasks();
...
import { tasksListTasks } from "@tirdad-ai/sdk/funcs/tasks-list-tasks.js";
...
async function run() {
  const res = await tasksListTasks(tirdad);
  if (res.ok) {
...
async function run() {
  const result = await tirdad.tasks.getTaskResult("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { tasksGetTaskResult } from "@tirdad-ai/sdk/funcs/tasks-get-task-result.js";
...
async function run() {
  const res = await tasksGetTaskResult(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.tasks.getTask("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { tasksGetTask } from "@tirdad-ai/sdk/funcs/tasks-get-task.js";
...
async function run() {
  const res = await tasksGetTask(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.tasks.downloadTaskExport("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { tasksDownloadTaskExport } from "@tirdad-ai/sdk/funcs/tasks-download-task-export.js";
...
async function run() {
  const res = await tasksDownloadTaskExport(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.tasks.updateTaskStatus("<id>", {
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { tasksUpdateTaskStatus } from "@tirdad-ai/sdk/funcs/tasks-update-task-status.js";
...
async function run() {
  const res = await tasksUpdateTaskStatus(tirdad, "<id>", {
    taskStatus: "PROCESSING",
  });
  if (res.ok) {
    const { value: result } = res;
