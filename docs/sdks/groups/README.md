...
async function run() {
  const result = await tirdad.groups.createGroup({
    entityType: "<value>",
    lookupKey: "<value>",
    name: "<value>",
  });
...
import { groupsCreateGroup } from "@tirdad-ai/sdk/funcs/groups-create-group.js";
...
async function run() {
  const res = await groupsCreateGroup(tirdad, {
    entityType: "<value>",
    lookupKey: "<value>",
    name: "<value>",
  });
...
async function run() {
  const result = await tirdad.groups.queryGroup({});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { groupsQueryGroup } from "@tirdad-ai/sdk/funcs/groups-query-group.js";
...
async function run() {
  const res = await groupsQueryGroup(tirdad, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.groups.getGroup("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { groupsGetGroup } from "@tirdad-ai/sdk/funcs/groups-get-group.js";
...
async function run() {
  const res = await groupsGetGroup(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  await tirdad.groups.deleteGroup("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { groupsDeleteGroup } from "@tirdad-ai/sdk/funcs/groups-delete-group.js";
...
async function run() {
  const res = await groupsDeleteGroup(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
