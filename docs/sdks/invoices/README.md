...
async function run() {
  const result = await tirdad.invoices.getCustomerInvoiceSummary("<id>");
...
import { invoicesGetCustomerInvoiceSummary } from "@tirdad-ai/sdk/funcs/invoices-get-customer-invoice-summary.js";
...
async function run() {
  const res = await invoicesGetCustomerInvoiceSummary(tirdad, "<id>");
  if (res.ok) {
...
**Promise\<[models.CustomerMultiCurrencyInvoiceSummary](../../sdk/models/customer-multi-currency-invoice-summary.md)\>**
...
async function run() {
  const result = await tirdad.invoices.createInvoice({
    amountDue: "<value>",
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesCreateInvoice } from "@tirdad-ai/sdk/funcs/invoices-create-invoice.js";
...
async function run() {
  const res = await invoicesCreateInvoice(tirdad, {
    amountDue: "<value>",
    currency: "Surinam Dollar",
    customerId: "<id>",
    subtotal: "<value>",
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.CreateInvoiceRequest](../../sdk/models/create-invoice-request.md)                                                                                                      | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await tirdad.invoices.getInvoicePreview({
    subscriptionId: "<id>",
  });
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesGetInvoicePreview } from "@tirdad-ai/sdk/funcs/invoices-get-invoice-preview.js";
...
async function run() {
  const res = await invoicesGetInvoicePreview(tirdad, {
    subscriptionId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await tirdad.invoices.queryInvoice({});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesQueryInvoice } from "@tirdad-ai/sdk/funcs/invoices-query-invoice.js";
...
async function run() {
  const res = await invoicesQueryInvoice(tirdad, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.InvoiceFilter](../../sdk/models/invoice-filter.md)                                                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.ListInvoicesResponse](../../sdk/models/list-invoices-response.md)\>**
...
async function run() {
  const result = await tirdad.invoices.getInvoice("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesGetInvoice } from "@tirdad-ai/sdk/funcs/invoices-get-invoice.js";
...
async function run() {
  const res = await invoicesGetInvoice(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.invoices.updateInvoice("<id>", {});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesUpdateInvoice } from "@tirdad-ai/sdk/funcs/invoices-update-invoice.js";
...
async function run() {
  const res = await invoicesUpdateInvoice(tirdad, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.invoices.triggerInvoiceCommsWebhook("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesTriggerInvoiceCommsWebhook } from "@tirdad-ai/sdk/funcs/invoices-trigger-invoice-comms-webhook.js";
...
async function run() {
  const res = await invoicesTriggerInvoiceCommsWebhook(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.invoices.finalizeInvoice("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesFinalizeInvoice } from "@tirdad-ai/sdk/funcs/invoices-finalize-invoice.js";
...
async function run() {
  const res = await invoicesFinalizeInvoice(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.invoices.updateInvoicePaymentStatus("<id>", {
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesUpdateInvoicePaymentStatus } from "@tirdad-ai/sdk/funcs/invoices-update-invoice-payment-status.js";
...
async function run() {
  const res = await invoicesUpdateInvoicePaymentStatus(tirdad, "<id>", {
    paymentStatus: "INITIATED",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await tirdad.invoices.attemptInvoicePayment("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesAttemptInvoicePayment } from "@tirdad-ai/sdk/funcs/invoices-attempt-invoice-payment.js";
...
async function run() {
  const res = await invoicesAttemptInvoicePayment(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.invoices.getInvoicePdf("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesGetInvoicePdf } from "@tirdad-ai/sdk/funcs/invoices-get-invoice-pdf.js";
...
async function run() {
  const res = await invoicesGetInvoicePdf(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.invoices.recalculateInvoice("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesRecalculateInvoice } from "@tirdad-ai/sdk/funcs/invoices-recalculate-invoice.js";
...
async function run() {
  const res = await invoicesRecalculateInvoice(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.invoices.recalculateInvoiceV2("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesRecalculateInvoiceV2 } from "@tirdad-ai/sdk/funcs/invoices-recalculate-invoice-v2.js";
...
async function run() {
  const res = await invoicesRecalculateInvoiceV2(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.invoices.voidInvoice("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { invoicesVoidInvoice } from "@tirdad-ai/sdk/funcs/invoices-void-invoice.js";
...
async function run() {
  const res = await invoicesVoidInvoice(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
