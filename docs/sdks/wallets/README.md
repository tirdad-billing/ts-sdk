...
async function run() {
  const result = await tirdad.wallets.getCustomerWallets({});
...
async function run() {
  const res = await walletsGetCustomerWallets(tirdad, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.wallets.getWalletsByCustomerId("<id>");
...
async function run() {
  const res = await walletsGetWalletsByCustomerId(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.wallets.queryWallet({});
...
async function run() {
  const res = await walletsQueryWallet(tirdad, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.wallets.queryWalletTransaction({});
...
async function run() {
  const res = await walletsQueryWalletTransaction(tirdad, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.wallets.updateWallet("<id>", {});
...
async function run() {
  const res = await walletsUpdateWallet(tirdad, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
