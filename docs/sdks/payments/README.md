...
async function run() {
  const result = await tirdad.payments.listPayments();
...
import { paymentsListPayments } from "@tirdad-ai/sdk/funcs/payments-list-payments.js";
...
async function run() {
  const res = await paymentsListPayments(tirdad);
  if (res.ok) {
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.ListPaymentsRequest](../../sdk/models/list-payments-request.md)                                                                                                        | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.ListPaymentsResponse](../../sdk/models/list-payments-response.md)\>**
...
async function run() {
  const result = await tirdad.payments.createPayment({
    amount: "883.46",
    currency: "CFP Franc",
    destinationId: "<id>",
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { paymentsCreatePayment } from "@tirdad-ai/sdk/funcs/payments-create-payment.js";
...
async function run() {
  const res = await paymentsCreatePayment(tirdad, {
    amount: "883.46",
    currency: "CFP Franc",
    destinationId: "<id>",
    destinationType: "CUSTOMER",
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.CreatePaymentRequest](../../sdk/models/create-payment-request.md)                                                                                                      | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await tirdad.payments.getPayment("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { paymentsGetPayment } from "@tirdad-ai/sdk/funcs/payments-get-payment.js";
...
async function run() {
  const res = await paymentsGetPayment(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.payments.updatePayment("<id>", {});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { paymentsUpdatePayment } from "@tirdad-ai/sdk/funcs/payments-update-payment.js";
...
async function run() {
  const res = await paymentsUpdatePayment(tirdad, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.payments.deletePayment("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { paymentsDeletePayment } from "@tirdad-ai/sdk/funcs/payments-delete-payment.js";
...
async function run() {
  const res = await paymentsDeletePayment(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.payments.processPayment("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { paymentsProcessPayment } from "@tirdad-ai/sdk/funcs/payments-process-payment.js";
...
async function run() {
  const res = await paymentsProcessPayment(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
