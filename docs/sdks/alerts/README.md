...
async function run() {
  const result = await tirdad.alerts.queryAlertLog({});
...
import { alertsQueryAlertLog } from "@tirdad-ai/sdk/funcs/alerts-query-alert-log.js";
...
async function run() {
  const res = await alertsQueryAlertLog(tirdad, {});
  if (res.ok) {
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.AlertLogFilter](../../sdk/models/alert-log-filter.md)                                                                                                                  | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.ListAlertLogsResponse](../../sdk/models/list-alert-logs-response.md)\>**
