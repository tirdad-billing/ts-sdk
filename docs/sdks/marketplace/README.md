...
async function run() {
  const result = await tirdad.marketplace.postMarketplaceAgreements({
    customerId: "<id>",
    planId: "<id>",
    provider: "tabs",
    subscriptionId: "<id>",
...
import { marketplacePostMarketplaceAgreements } from "@tirdad-ai/sdk/funcs/marketplace-post-marketplace-agreements.js";
...
async function run() {
  const res = await marketplacePostMarketplaceAgreements(tirdad, {
    customerId: "<id>",
    planId: "<id>",
    provider: "tabs",
    subscriptionId: "<id>",
