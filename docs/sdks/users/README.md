...
import { usersCreateUser } from "@tirdad-ai/sdk/funcs/users-create-user.js";
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { usersGetUserInfo } from "@tirdad-ai/sdk/funcs/users-get-user-info.js";
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { usersUpdateUser } from "@tirdad-ai/sdk/funcs/users-update-user.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.UpdateUserRequest](../../sdk/models/update-user-request.md)                                                                                                            | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.UpdateUserResponse](../../sdk/models/update-user-response.md)\>**
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { usersQueryUser } from "@tirdad-ai/sdk/funcs/users-query-user.js";
...
<!-- UsageSnippet language="typescript" operationID="updateServiceAccount" method="put" path="/users/{id}" -->
```typescript
import { Tirdad } from "@tirdad-ai/sdk";
...
async function run() {
  const result = await tirdad.users.updateServiceAccount("<id>", {
    name: "<value>",
  });
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { usersUpdateServiceAccount } from "@tirdad-ai/sdk/funcs/users-update-service-account.js";
...
async function run() {
  const res = await usersUpdateServiceAccount(tirdad, "<id>", {
    name: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("usersUpdateServiceAccount failed:", res.error);
  }
}
...
**Promise\<[models.UpdateServiceAccountResponse](../../sdk/models/update-service-account-response.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="deleteServiceAccount" method="delete" path="/users/{id}" -->
```typescript
import { Tirdad } from "@tirdad-ai/sdk";
...
async function run() {
  await tirdad.users.deleteServiceAccount("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { usersDeleteServiceAccount } from "@tirdad-ai/sdk/funcs/users-delete-service-account.js";
...
async function run() {
  const res = await usersDeleteServiceAccount(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    
  } else {
    console.log("usersDeleteServiceAccount failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="removeUser" method="post" path="/users/{id}/remove" -->
```typescript
import { Tirdad } from "@tirdad-ai/sdk";
...
async function run() {
  await tirdad.users.removeUser("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { usersRemoveUser } from "@tirdad-ai/sdk/funcs/users-remove-user.js";
...
async function run() {
  const res = await usersRemoveUser(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    
  } else {
    console.log("usersRemoveUser failed:", res.error);
  }
}
