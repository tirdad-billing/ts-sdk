...
<!-- UsageSnippet language="typescript" operationID="getAddonCreditGrants" method="get" path="/addons/{id}/creditgrants" -->
```typescript
...
async function run() {
  const result = await tirdad.creditGrants.getAddonCreditGrants("<id>");
...
import { creditGrantsGetAddonCreditGrants } from "@tirdad-ai/sdk/funcs/credit-grants-get-addon-credit-grants.js";
...
async function run() {
  const res = await creditGrantsGetAddonCreditGrants(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("creditGrantsGetAddonCreditGrants failed:", res.error);
  }
}
...
**Promise\<[models.ListCreditGrantsResponse](../../sdk/models/list-credit-grants-response.md)\>**
...
async function run() {
  const result = await tirdad.creditGrants.createCreditGrant({
    cadence: "ONETIME",
    credits: "<value>",
    name: "<value>",
    scope: "PLAN",
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { creditGrantsCreateCreditGrant } from "@tirdad-ai/sdk/funcs/credit-grants-create-credit-grant.js";
...
async function run() {
  const res = await creditGrantsCreateCreditGrant(tirdad, {
    cadence: "ONETIME",
    credits: "<value>",
    name: "<value>",
    scope: "PLAN",
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.CreateCreditGrantRequest](../../sdk/models/create-credit-grant-request.md)                                                                                             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.CreditGrantResponse](../../sdk/models/credit-grant-response.md)\>**
...
async function run() {
  const result = await tirdad.creditGrants.getCreditGrant("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { creditGrantsGetCreditGrant } from "@tirdad-ai/sdk/funcs/credit-grants-get-credit-grant.js";
...
async function run() {
  const res = await creditGrantsGetCreditGrant(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.creditGrants.updateCreditGrant("<id>", {});
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { creditGrantsUpdateCreditGrant } from "@tirdad-ai/sdk/funcs/credit-grants-update-credit-grant.js";
...
async function run() {
  const res = await creditGrantsUpdateCreditGrant(tirdad, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.creditGrants.deleteCreditGrant("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { creditGrantsDeleteCreditGrant } from "@tirdad-ai/sdk/funcs/credit-grants-delete-credit-grant.js";
...
async function run() {
  const res = await creditGrantsDeleteCreditGrant(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await tirdad.creditGrants.getPlanCreditGrants("<id>");
...
```typescript
import { TirdadCore } from "@tirdad-ai/sdk/core.js";
import { creditGrantsGetPlanCreditGrants } from "@tirdad-ai/sdk/funcs/credit-grants-get-plan-credit-grants.js";
...
async function run() {
  const res = await creditGrantsGetPlanCreditGrants(tirdad, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
