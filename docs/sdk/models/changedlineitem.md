...
```typescript
import { ChangedLineItem } from "@tirdad-ai/sdk/sdk/models";

let value: ChangedLineItem = {};
```
...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `changeAction`                                                                                | [models.ChangedLineItemAction](../../sdk/models/changedlineitemaction.md)                     | :heavy_minus_sign:                                                                            | created \| updated \| ended                                                                   |
