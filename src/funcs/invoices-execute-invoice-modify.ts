...
> {
  const input: models.ExecuteInvoiceModifyRequestRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.ExecuteInvoiceModifyRequestRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/invoices/{id}/modify/execute")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.InvoiceModifyResponse$inboundSchema),
