 ...
 */
export function webhookEventsPostWebhookEventsSubscriptionLineItemSpendThresholdReached(
  client: TirdadCore,
...
> {
  ...
  const context = {
    ...
    operationID:
      "post_/webhook-events/subscription.line_item_spend.threshold_reached",
    oAuth2Scopes: null,
