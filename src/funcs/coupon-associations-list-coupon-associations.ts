 ...
 */
export function couponAssociationsListCouponAssociations(
  client: TirdadCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(models.ListCouponAssociationsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/coupons/associations")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListCouponAssociationsResponse$inboundSchema),
