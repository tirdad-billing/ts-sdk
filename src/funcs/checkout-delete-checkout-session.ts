 ...
 */
export function checkoutDeleteCheckoutSession(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.DeleteCheckoutSessionRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.DeleteCheckoutSessionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/checkout/sessions/{id}")(pathParams);
