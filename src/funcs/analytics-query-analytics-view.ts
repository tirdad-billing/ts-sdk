 ...
 */
export function analyticsQueryAnalyticsView(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.QueryAnalyticsViewRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => z.parse(models.QueryAnalyticsViewRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/analytics/views/{id}/query")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AnalyticsQueryResult$inboundSchema),
