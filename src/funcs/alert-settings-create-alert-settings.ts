 ...
 */
export function alertSettingsCreateAlertSettings(
  client: TirdadCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateAlertSettingsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/alerts/setting")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.AlertSettingsResponse$inboundSchema),
