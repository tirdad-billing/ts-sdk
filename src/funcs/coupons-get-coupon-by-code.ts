 ...
 */
export function couponsGetCouponByCode(
  client: TirdadCore,
  code: string,
...
> {
  const input: models.GetCouponByCodeRequest = {
    code: code,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.GetCouponByCodeRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/coupons/code/{code}")(pathParams);
