 ...
 */
export function usersUpdateServiceAccount(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.UpdateServiceAccountRequestRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.UpdateServiceAccountRequestRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateServiceAccountResponse$inboundSchema),
