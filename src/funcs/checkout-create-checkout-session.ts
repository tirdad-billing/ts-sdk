 ...
 */
export function checkoutCreateCheckoutSession(
  client: TirdadCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.CreateCheckoutSessionRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.CheckoutSessionResponse$inboundSchema),
    M.jsonErr([400, 409], models.ErrorsErrorResponse$inboundSchema),
