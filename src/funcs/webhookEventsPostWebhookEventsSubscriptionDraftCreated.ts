 ...
 */
export function webhookEventsPostWebhookEventsSubscriptionDraftCreated(
  client: TirdadCore,
...
> {
  const path = pathToFunc("/webhook-events/subscription.draft.created")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WebhookDtoSubscriptionWebhookPayload$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
