 ...
 */
export function analyticsCreateAnalyticsView(
  client: TirdadCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateViewRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/analytics/views")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.ViewResponse$inboundSchema),
