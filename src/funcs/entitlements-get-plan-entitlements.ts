...
> {
  const input: models.GetPlanEntitlementsRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.GetPlanEntitlementsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListEntitlementsResponse$inboundSchema),
