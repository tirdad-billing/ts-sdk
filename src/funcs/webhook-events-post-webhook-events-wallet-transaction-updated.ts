 ...
 */
export function webhookEventsPostWebhookEventsWalletTransactionUpdated(
  client: TirdadCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.WebhookDtoTransactionUpdatedWebhookPayload,
    | TirdadError
...
> {
  const path = pathToFunc("/webhook-events/wallet.transaction.updated")();
  ...
  >(
    M.json(
      200,
      models.WebhookDtoTransactionUpdatedWebhookPayload$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
