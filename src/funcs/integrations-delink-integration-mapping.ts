 ...
 */
export function integrationsDelinkIntegrationMapping(
  client: TirdadCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.DelinkIntegrationMappingRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/link")();
