 ...
 */
export function integrationsGetEntityIntegrationMappings(
  client: TirdadCore,
  entityType: string,
  entityId: string,
...
> {
  const input: models.GetEntityIntegrationMappingsRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      models.GetEntityIntegrationMappingsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/integrations/mappings")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListEntityIntegrationMappingsResponse$inboundSchema),
