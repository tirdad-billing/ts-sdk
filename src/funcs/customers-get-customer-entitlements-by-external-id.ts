...
> {
  const input: models.GetCustomerEntitlementsByExternalIDRequest = {
  ...
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        models.GetCustomerEntitlementsByExternalIDRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CustomerEntitlementsResponse$inboundSchema),
