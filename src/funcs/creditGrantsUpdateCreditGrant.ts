...
> {
  const input: models.UpdateCreditGrantRequestRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      models.UpdateCreditGrantRequestRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreditGrantResponse$inboundSchema),
