...
> {
  const input: models.PreviewSubscriptionChangeRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.PreviewSubscriptionChangeRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SubscriptionChangePreviewResponse$inboundSchema),
