 ...
 */
export function webhookEventsPostWebhookEventsEventRejected(
  client: TirdadCore,
...
> {
  const path = pathToFunc("/webhook-events/event.rejected")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WebhookDtoRejectedEventWebhookPayload$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
