...
> {
  const input: models.ExecuteSubscriptionChangeRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.ExecuteSubscriptionChangeRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SubscriptionChangeExecuteResponse$inboundSchema),
