 ...
 */
export function usersRemoveUser(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.RemoveUserRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.RemoveUserRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/users/{id}/remove")(pathParams);
