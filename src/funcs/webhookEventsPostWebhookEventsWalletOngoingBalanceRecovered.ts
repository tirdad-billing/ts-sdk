 ...
 */
export function webhookEventsPostWebhookEventsWalletOngoingBalanceRecovered(
  client: TirdadCore,
...
> {
  const path = pathToFunc("/webhook-events/wallet.ongoing_balance.recovered")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WebhookDtoWalletWebhookPayload$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
