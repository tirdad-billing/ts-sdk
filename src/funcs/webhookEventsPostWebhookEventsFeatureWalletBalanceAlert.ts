 ...
 */
export function webhookEventsPostWebhookEventsFeatureWalletBalanceAlert(
  client: TirdadCore,
...
> {
  const path = pathToFunc("/webhook-events/feature.wallet_balance.alert")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WebhookDtoAlertWebhookPayload$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
