 ...
 */
export function refundsGetRefund(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.GetRefundRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.GetRefundRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/refunds/{id}")(pathParams);
