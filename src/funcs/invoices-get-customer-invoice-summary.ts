...
> {
  const input: models.GetCustomerInvoiceSummaryRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.GetCustomerInvoiceSummaryRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CustomerMultiCurrencyInvoiceSummary$inboundSchema),
