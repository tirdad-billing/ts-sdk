 ...
 */
export function couponAssociationsGetCouponAssociation(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.GetCouponAssociationRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.GetCouponAssociationRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/coupons/associations/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CouponAssociationResponse$inboundSchema),
