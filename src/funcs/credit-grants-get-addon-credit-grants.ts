 ...
 */
export function creditGrantsGetAddonCreditGrants(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.GetAddonCreditGrantsRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.GetAddonCreditGrantsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/addons/{id}/creditgrants")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListCreditGrantsResponse$inboundSchema),
