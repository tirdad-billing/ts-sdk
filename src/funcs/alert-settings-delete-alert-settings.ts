 ...
 */
export function alertSettingsDeleteAlertSettings(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.DeleteAlertSettingsRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.DeleteAlertSettingsRequest$outboundSchema, value),
