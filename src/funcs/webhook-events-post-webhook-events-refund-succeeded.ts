 ...
 */
export function webhookEventsPostWebhookEventsRefundSucceeded(
  client: TirdadCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.WebhookDtoRefundWebhookPayload,
    | TirdadError
...
> {
  const path = pathToFunc("/webhook-events/refund.succeeded")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WebhookDtoRefundWebhookPayload$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
