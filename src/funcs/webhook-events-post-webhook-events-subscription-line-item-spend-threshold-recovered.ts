 ...
 */
export function webhookEventsPostWebhookEventsSubscriptionLineItemSpendThresholdRecovered(
  client: TirdadCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.WebhookDtoSpendAlertEvent,
    | TirdadError
...
> {
  ...
  const context = {
    ...
    operationID:
      "post_/webhook-events/subscription.line_item_spend.threshold_recovered",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WebhookDtoSpendAlertEvent$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
