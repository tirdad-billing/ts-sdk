...
> {
  const input: models.GetWalletBalanceRequest = {
    id: id,
    expand: expand,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => z.parse(models.GetWalletBalanceRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WalletBalanceResponse$inboundSchema),
