 ...
 */
export function usersDeleteServiceAccount(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.DeleteServiceAccountRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.DeleteServiceAccountRequest$outboundSchema, value),
