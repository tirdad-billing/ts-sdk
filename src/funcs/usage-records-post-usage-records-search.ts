 ...
 */
export function usageRecordsPostUsageRecordsSearch(
  client: TirdadCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.UsageRecordFilter$outboundSchema, value),
  ...
  const path = pathToFunc("/usage-records/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListUsageRecordsResponse$inboundSchema),
