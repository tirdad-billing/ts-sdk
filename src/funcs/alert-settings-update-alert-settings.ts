 ...
 */
export function alertSettingsUpdateAlertSettings(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.UpdateAlertSettingsRequestRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.UpdateAlertSettingsRequestRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/alerts/setting/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AlertSettingsResponse$inboundSchema),
