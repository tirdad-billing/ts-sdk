 ...
 */
export function refundsRetryRefund(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.RetryRefundRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.RetryRefundRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/refunds/{id}/retry")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RefundResponse$inboundSchema),
    M.jsonErr([400, 401, 404], models.ErrorsErrorResponse$inboundSchema),
