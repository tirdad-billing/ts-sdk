 ...
 */
export function alertSettingsQueryAlertSettings(
  client: TirdadCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AlertSettingsFilter$outboundSchema, value),
  ...
  const path = pathToFunc("/alerts/setting/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListAlertSettingsResponse$inboundSchema),
