 ...
 */
export function webhookEventsPostWebhookEventsSubscriptionGroupSpendThresholdRecovered(
  client: TirdadCore,
...
> {
  ...
  const context = {
    ...
    operationID:
      "post_/webhook-events/subscription.group_spend.threshold_recovered",
    oAuth2Scopes: null,
