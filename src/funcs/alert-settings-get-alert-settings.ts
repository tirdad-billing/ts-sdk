 ...
 */
export function alertSettingsGetAlertSettings(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.GetAlertSettingsRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.GetAlertSettingsRequest$outboundSchema, value),
