 ...
 */
export function checkoutGetCheckoutSession(
  client: TirdadCore,
  id: string,
...
> {
  const input: models.GetCheckoutSessionRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.GetCheckoutSessionRequest$outboundSchema, value),
