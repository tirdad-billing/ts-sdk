...
> {
  const input: models.UpdateSubscriptionLineItemRequestRequest = {
    id: id,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      models.UpdateSubscriptionLineItemRequestRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SubscriptionLineItemResponse$inboundSchema),
