...
export type InvoiceLineItemResponse = {
   ...
   */
  parentLineItemId?: string | undefined;
...
/** @internal */
export const InvoiceLineItemResponse$inboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    parent_line_item_id: types.optional(types.string()),
