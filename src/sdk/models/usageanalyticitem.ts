...
import { GroupGroup, GroupGroup$inboundSchema } from "./groupgroup.js";
...
/** @internal */
export const UsageAnalyticItem$inboundSchema: z.ZodType<
  UsageAnalyticItem,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  properties: types.optional(z.record(types.string())),
