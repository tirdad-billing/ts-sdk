...
export type SubscriptionResponseV2 = {
   ...
   */
  lineItems?: Array<SubscriptionLineItemResponse> | undefined;
  /**
...
/** @internal */
export const SubscriptionResponseV2$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  pauses: types.optional(z.array(SubscriptionSubscriptionPause$inboundSchema)),
...
export function subscriptionResponseV2FromJSON(
  jsonString: string,
): SafeParseResult<SubscriptionResponseV2, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => SubscriptionResponseV2$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SubscriptionResponseV2' from JSON`,
  );
}
