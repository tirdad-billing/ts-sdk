...
import { webhookEventsPostWebhookEventsCheckoutSessionCompleted } from "../funcs/webhook-events-post-webhook-events-checkout-session-completed.js";
import { webhookEventsPostWebhookEventsCheckoutSessionExpired } from "../funcs/webhook-events-post-webhook-events-checkout-session-expired.js";
import { webhookEventsPostWebhookEventsCheckoutSessionFailed } from "../funcs/webhook-events-post-webhook-events-checkout-session-failed.js";
import { webhookEventsPostWebhookEventsCheckoutSessionInitiated } from "../funcs/webhook-events-post-webhook-events-checkout-session-initiated.js";
...
import { webhookEventsPostWebhookEventsSubscriptionGroupSpendThresholdReached } from "../funcs/webhook-events-post-webhook-events-subscription-group-spend-threshold-reached.js";
import { webhookEventsPostWebhookEventsSubscriptionGroupSpendThresholdRecovered } from "../funcs/webhook-events-post-webhook-events-subscription-group-spend-threshold-recovered.js";
import { webhookEventsPostWebhookEventsSubscriptionLineItemSpendThresholdReached } from "../funcs/webhook-events-post-webhook-events-subscription-line-item-spend-threshold-reached.js";
import { webhookEventsPostWebhookEventsSubscriptionLineItemSpendThresholdRecovered } from "../funcs/webhook-events-post-webhook-events-subscription-line-item-spend-threshold-recovered.js";
...
import { webhookEventsPostWebhookEventsSubscriptionSpendThresholdRecovered } from "../funcs/webhook-events-post-webhook-events-subscription-spend-threshold-recovered.js";
...
import { webhookEventsPostWebhookEventsWalletOngoingBalanceUpdated } from "../funcs/webhook-events-post-webhook-events-wallet-ongoing-balance-updated.js";
...
import { webhookEventsPostWebhookEventsWalletTransactionUpdated } from "../funcs/webhook-events-post-webhook-events-wallet-transaction-updated.js";
...
export class WebhookEvents extends ClientSDK {
   ...
   */
  async postWebhookEventsCheckoutSessionCompleted(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoCheckoutSessionWebhookPayload> {
    return unwrapAsync(webhookEventsPostWebhookEventsCheckoutSessionCompleted(
      this,
      options,
    ));
  }
   ...
   */
  async postWebhookEventsCheckoutSessionExpired(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoCheckoutSessionWebhookPayload> {
    return unwrapAsync(webhookEventsPostWebhookEventsCheckoutSessionExpired(
      this,
      options,
    ));
  }
   ...
   */
  async postWebhookEventsCheckoutSessionFailed(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoCheckoutSessionWebhookPayload> {
    return unwrapAsync(webhookEventsPostWebhookEventsCheckoutSessionFailed(
      this,
      options,
    ));
  }
   ...
   */
  async postWebhookEventsCheckoutSessionInitiated(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoCheckoutSessionWebhookPayload> {
    return unwrapAsync(webhookEventsPostWebhookEventsCheckoutSessionInitiated(
      this,
      options,
    ));
  }
   ...
   */
  async postWebhookEventsSubscriptionGroupSpendThresholdReached(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoSpendAlertEvent> {
    return unwrapAsync(
      webhookEventsPostWebhookEventsSubscriptionGroupSpendThresholdReached(
        this,
        options,
      ),
    );
   ...
   */
  async postWebhookEventsSubscriptionGroupSpendThresholdRecovered(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoSpendAlertEvent> {
    return unwrapAsync(
      webhookEventsPostWebhookEventsSubscriptionGroupSpendThresholdRecovered(
        this,
        options,
      ),
    );
   ...
   */
  async postWebhookEventsSubscriptionLineItemSpendThresholdReached(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoSpendAlertEvent> {
    return unwrapAsync(
      webhookEventsPostWebhookEventsSubscriptionLineItemSpendThresholdReached(
        this,
        options,
      ),
    );
   ...
   */
  async postWebhookEventsSubscriptionLineItemSpendThresholdRecovered(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoSpendAlertEvent> {
    return unwrapAsync(
      webhookEventsPostWebhookEventsSubscriptionLineItemSpendThresholdRecovered(
        this,
        options,
      ),
    );
   ...
   */
  async postWebhookEventsSubscriptionSpendThresholdReached(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoSpendAlertEvent> {
    return unwrapAsync(
      webhookEventsPostWebhookEventsSubscriptionSpendThresholdReached(
        this,
        options,
      ),
    );
   ...
   */
  async postWebhookEventsSubscriptionSpendThresholdRecovered(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoSpendAlertEvent> {
    return unwrapAsync(
      webhookEventsPostWebhookEventsSubscriptionSpendThresholdRecovered(
        this,
        options,
      ),
    );
   ...
   */
  async postWebhookEventsWalletOngoingBalanceUpdated(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoWalletWebhookPayload> {
    return unwrapAsync(
      webhookEventsPostWebhookEventsWalletOngoingBalanceUpdated(
        this,
        options,
      ),
    );
   ...
   */
  async postWebhookEventsWalletTransactionUpdated(
    options?: RequestOptions,
  ): Promise<models.WebhookDtoTransactionUpdatedWebhookPayload> {
    return unwrapAsync(webhookEventsPostWebhookEventsWalletTransactionUpdated(
      this,
      options,
    ));
  }
